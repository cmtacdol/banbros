        ...
        <nav class="pcoded-navbar">
            <div class="nav-list">
                <div class="pcoded-inner-navbar main-menu">
                    ...
                    <ul class="pcoded-item pcoded-left-item">
                        ...
                        <li class="pcoded-hasmenu">
                            ...
                            <ul class="pcoded-submenu">
                                ...
                                <li class="">
                                    <a href="home_press_release.php" class="waves-effect waves-dark">
                                        <span class="pcoded-micon">
                                            <i class="feather icon-image"></i>
                                        </span>
                    ...
                    <ul class="pcoded-item pcoded-left-item">
                        <li class="">
                            <a href="about_tab.php" class="waves-effect waves-dark">
                                <span class="pcoded-micon">
                    ...
                    <ul class="pcoded-item pcoded-left-item">
                        <li class="">
                            <a href="career.php" class="waves-effect waves-dark">
                                <span class="pcoded-micon">
                    ...
                    <!-- <ul class="pcoded-item pcoded-left-item">
                        ...
                        <li class="pcoded-hasmenu">
                            <a href="javascript:void(0)" class="waves-effect waves-dark">
                                ...
                                <span class="pcoded-mtext">Access Groups</span>
                            </a>
                            <ul class="pcoded-submenu">
                                <li class="">
                    ...
                    <ul class="pcoded-item pcoded-left-item">
                        <li class="">
                            <a href="menu_add.php" class="waves-effect waves-dark">
                                ...
                                <span class="pcoded-mtext">Add Menu</span>
                            </a>
                        </li>
                        <li class="">
