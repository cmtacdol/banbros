...
$_SESSION['PAGE_NAV_TITLE'] = "Edit User";
include 'view/common/header.php';
include 'controller/usersController.php';

if(isset($_POST['updateUser'])){
    updateUsers($_POST, $_FILES);
    echo '<script>window.history.replaceState( null, null, window.location.href );</script>';
}

$role = getRolePermission();
$singleUser = getSingleUsers($_GET['id_user']);
?>
                                ...
                                <div class="col-4 text-center">
                                    <label for="fileImage">
                                        <div class="profile-pic"
                                            style="background-image: url('<?php echo (!empty($singleUser['Image'])) ? '../../'.$singleUser['Image'] : 'view/images/no-image.jpg' ?>')">
                                ...
                                <div class="row align-items-top">
                                    <div class="col-lg-6">
                                        <div class="form-group scroll">
                                            ...
                                            <input class="form-control" type="text" name="Name" value="<?php echo $singleUser['Name']; ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group scroll">
                                            <label for="exampleInputEmail1">Username</label>
                                            <input class="form-control" type="text" name="Username" value="<?php echo $singleUser['Username']; ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group scroll">
                                            <label for="exampleInputEmail1">Email</label>
                                            <input class="form-control" type="email" name="Email" value="<?php echo $singleUser['Email']; ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group scroll">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-sm" id="Status" name="Status">
                                                <option value="0" <?php echo ($singleUser['UserStatus'] == '0') ? 'selected' : ''; ?>>Active</option>
                                                <option value="1" <?php echo ($singleUser['UserStatus'] == '1') ? 'selected' : ''; ?>>Inactive</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-sm" id="RolePermission"
                                                ...
                                                <option value="<?php echo $permission['IdPermission']; ?>" <?php echo ($singleUser['PermissionId'] == $permission['IdPermission']) ? 'selected' : ''; ?>>
