<?php 
session_start();
$_SESSION['PAGE_TITLE'] = "Add New Promo";
$_SESSION['PAGE_NAV_TITLE'] = "Add New Promo";
include 'view/common/header.php';
include 'controller/promoController.php';

if(isset($_POST['savePromos'])){
    savePromos($_POST, $_FILES);
                    ...
                    <div class="page-header card">
                        <div class="row">
                            <div class="col-lg">
                                ...
                                <button type="submit" name="savePromos"
