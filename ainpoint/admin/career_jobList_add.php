<?php 
session_start();
$_SESSION['PAGE_TITLE'] = "Add New Jobs";
$_SESSION['PAGE_NAV_TITLE'] = "Add New Jobs";
include 'view/common/header.php';
include 'controller/careerController.php';

if(isset($_POST['saveJobs'])){
    saveJobDescription($_POST);
                    ...
                    <div class="page-header card">
                        <div class="row">
                            <div class="col-lg">
                                ...
                                <button type="submit" name="saveJobs"
                                ...
                                <div class="row align-items-top">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="form-group scroll">
                                            ...
                                            <input class="form-control" type="text" name="ApplyNowLink">
                                        </div>
