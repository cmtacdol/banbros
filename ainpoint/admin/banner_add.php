                                ...
                                <div class="table-responsive dt-responsive">
                                    <table id="bannerTable" class="table table-striped table-bordered nowrap">
                                       ...
                                       <?php foreach($banner as $getbanner){ ?>
                                        <tr>
                                            <td>
                                                <input type="hidden" name="idBanner[]" class="form-control form-control-sm mt-4" value="<?php echo $getbanner['IdBanner']; ?>">
                                                <img src="../<?php echo $getbanner['Image']; ?>" style="width: 300px; height: 100px; object-fit: contain">
                                            </td>
                                            <td>
                                                <input type="text" name="link[]" class="form-control form-control-sm mt-4" value="<?php echo $getbanner['Link']; ?>">
                                            </td>
                                            <td>
                                                <button type="submit" name="deleteBanner" value="<?php echo $getbanner['IdBanner']; ?>" class="col-auto btn btn-danger mt-4"><i class="icofont icofont-trash"></i></button>
                                            </td>
                                        </tr>
                                       <?php } ?>
                                       <?php } ?>
        ...
        $(add_button_image).click(function(e) { //on add input button click
            ...
            if (x3 < max_fields_image) { //max input box allowed
                ...
                $(wrapper_image).append(
                    '<tr><td><input type="file" name="images[]" class="form-control form-control-sm mt-4"></td><td><input type="text" name="link[]" class="form-control form-control-sm mt-4"></td><td><a href="#" class="col-auto remove_field btn btn-danger mt-4"><i class="icofont icofont-trash"></i></a></td></tr>'
                ); //add input box
            }
        });
