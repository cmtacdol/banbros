...
<body class="clean-body" style="margin: 0; padding: 0; -webkit-text-size-adjust: 100%; background-color: #606062;">
    <!--[if IE]><div class="ie-browser"><![endif]-->
    <table bgcolor="#ffcc00" cellpadding="0" cellspacing="0" class="nl-container" role="presentation"
        style="table-layout: fixed; vertical-align: top; min-width: 320px; Margin: 0 auto; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #606062; width: 100%;"
                                        ...
                                        <div
                                            ...
                                            <div align="center" class="img-container center fullwidth"
                                                ...
                                                <div style="font-size:1px;line-height:25px"> </div><img align="center"
                                                    alt="Image" border="0" class="center fullwidth"
                                                    src="https://recoletoslawcenter.com.ph/assets/img/rounder-up.png"
                                ...
                                <div class="col num12"
                                        ...
                                        <div style="margin: 0 25%; width: 50%;">
                                            ...
                                            include 'admin/controller/usersController.php'; 
                                                ...
                                                if(isset($_GET['key']) && isset($_GET['email'])) {
                                                    $key=$_GET['key'];
                                                    $email=$_GET['email'];
                                                    $check=mysqli_query($db_conn,"SELECT * FROM users_forgot_password WHERE email='$email' and temp_key='$key'");
                                                ...
                                                if($_SERVER["REQUEST_METHOD"] == "POST"){
                                                    $password1=mysqli_real_escape_string($db_conn,$_POST['password']);
                                                    $password2=mysqli_real_escape_string($db_conn,$_POST['cpassword']);
                                                    if ($password2==$password1) {
                                                        $password=md5($password1);
                                                        //destroy the key from table
                                                        mysqli_query($db_conn,"DELETE FROM users_forgot_password where email='$email' and temp_key='$key'");
                                                        //update password in database
                                                        mysqli_query($db_conn,"UPDATE users set Password = '$password' where Email = '$email'");

                                                        echo "<script type='text/javascript'>";
                                                        echo "window.alert('New password has been set');";
                                                        echo "location.href='index.php';";
                                                        echo "</script>";
                                                    }
                                                    else{
                                                        echo "<script type='text/javascript'>";
                                                        echo "window.alert('Verify Password');";
                                                        echo "location.href='index.php';";
                                                        echo "</script>";
                                                    }
                                            }
                                            ?>
                                            <form method="post">
                                                <input style="outline: none; width: 95%; margin: 1% 0;" type="password"
                                                    name="password" placeholder="Password" required><br>
                                                <input style="outline: none; width: 95%; margin: 1% 0;" type="password"
                                                    name="cpassword" placeholder="Confirm Password" required><br>
                                                <input
                                                    style="background: #0094DA; color: white; padding: 3% 4%; border-radius: 5px; outline:none; cursor:pointer; border: none;"
                                                    type="submit" name="btnSubmit" value="Reset">
                                            </form>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <p
                                                style="font-size: 12px; line-height: 1.5; text-align: center; word-break: break-word; mso-line-height-alt: 21px; margin: 3% 5%;">
                                                <br />Please ensure your account security.<br />
                                                Thank you!<br /><br />Sta Lucia Prime Administrator
                                            </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
