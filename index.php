...
<body>
    ...
    <section class="js-parallax u-promo-block u-promo-block--mheight-600 u-overlay u-overlay--dark text-white"
        style="background-image: url(assets/1920x1080/BBCC.jpg);">
        <!-- Promo Content -->
        ...
        <section class="u-content-space">
            <div class="container mx-auto w-100 ">
                <div class="row">
                    <!-- Article Image -->
                    <div class="col-lg-6">
                        <img class="img-fluid products rounded" src="assets/img/sampleImage.jpg"
                    ...
                    <div class="col-lg-6 mb-5 mb-lg-0 p-2 text-center text-lg-left">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <small>Banbros Commercial Inc. vision is to be the Global forefront Top Tier value-added
                                    Supplier of Innovative IT products and end-to-end services in the Information
                                    Technology distribution industry by providing holistic and complementing products to
                                    provide strong and consistent growth in both revenues and profit for the company and
                                    for its partners.</small>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col">
                                ...
                                <small>Banbros Commercial Inc. mission is to be the top forefront Innovator that
                                    provides IT products, essentials, holistic solution and excellent services all in
                                    one for customer Satisfaction. We continuously seek improvements for more efficient,
                                    productive and satisfied employees, reseller and customer so we can all gain growth
                                    in all aspects.</small>
                            </div>
                        </div>
